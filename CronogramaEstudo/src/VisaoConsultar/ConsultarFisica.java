...
public class ConsultarFisica extends javax.swing.JFrame {

    public ConsultarFisica() {
        initComponents();
        setSize(781,410);
          AtualizaTable();
    }
     ...
     public void BuscarNome(){
        ...
        FisicaDAO bd =  new FisicaDAO(con);
        List<Fisica> lista = new ArrayList();
        lista = bd.PesquisarNomeFisica(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Fisica> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoFisica(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
