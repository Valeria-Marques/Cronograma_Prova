...
public class ConsultarBiologia extends javax.swing.JFrame {

    public ConsultarBiologia() {
        initComponents();
        setSize(781,410);
          AtualizaTable();
    }
     ...
     public void BuscarNome(){
        ...
        BiologiaDAO bd =  new BiologiaDAO(con);
        List<Biologia> lista = new ArrayList();
        lista = bd.PesquisarNomeBiologia(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Biologia> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoBiologia(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
