...
public class ConsultarGeografia extends javax.swing.JFrame {
    ...
    public ConsultarGeografia() {
     ...
     public void BuscarNome(){
        ...
        GeografiaDAO bd =  new GeografiaDAO(con);
        List<Geografia> lista = new ArrayList();
        lista = bd.PesquisarNomeGeografia(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Geografia> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoGeografia(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
