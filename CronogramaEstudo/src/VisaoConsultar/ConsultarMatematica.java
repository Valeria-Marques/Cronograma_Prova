...
public class ConsultarMatematica extends javax.swing.JFrame {

    public ConsultarMatematica() {
        initComponents();
        setSize(781,410);
          AtualizaTable();
    }
     ...
     public void BuscarNome(){
        ...
        MatematicaDAO bd =  new MatematicaDAO(con);
        List<Matematica> lista = new ArrayList();
        lista = bd.PesquisarNomeMatematica(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Matematica> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoMatematica(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
