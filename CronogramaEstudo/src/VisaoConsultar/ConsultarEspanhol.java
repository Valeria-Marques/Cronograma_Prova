...
public class ConsultarEspanhol extends javax.swing.JFrame {

    public ConsultarEspanhol() {
        initComponents();
        setSize(781,410);
          AtualizaTable();
    }
     ...
     public void BuscarNome(){
        ...
        EspanholDAO bd =  new EspanholDAO(con);
        List<Espanhol> lista = new ArrayList();
        lista = bd.PesquisarNomeEspanhol(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Espanhol> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoEspanhol(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
