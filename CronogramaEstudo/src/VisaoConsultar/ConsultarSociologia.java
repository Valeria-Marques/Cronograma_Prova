...
public class ConsultarSociologia extends javax.swing.JFrame {

    public ConsultarSociologia() {
        initComponents();
        setSize(781,410);
          AtualizaTable();
    }
     ...
     public void BuscarNome(){
        ...
        SociologiaDAO bd =  new SociologiaDAO(con);
        List<Sociologia> lista = new ArrayList();
        lista = bd.PesquisarNomeSociologia(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Sociologia> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoSociologia(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
