...
public class ConsultarQuimica extends javax.swing.JFrame {

    public ConsultarQuimica() {
        initComponents();
        setSize(781,410);
          AtualizaTable();
    }
     ...
     public void BuscarNome(){
        ...
        QuimicaDAO bd =  new QuimicaDAO(con);
        List<Quimica> lista = new ArrayList();
        lista = bd.PesquisarNomeQuimica(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Quimica> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoQuimica(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
