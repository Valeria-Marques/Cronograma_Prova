...
public class ConsultarFilosofia extends javax.swing.JFrame {

    public ConsultarFilosofia() {
        initComponents();
        setSize(781,410);
          AtualizaTable();
    }
     ...
     public void BuscarNome(){
        ...
        FilosofiaDAO bd =  new FilosofiaDAO(con);
        List<Filosofia> lista = new ArrayList();
        lista = bd.PesquisarNomeFilosofia(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Filosofia> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoFilosofia(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
