...
public class ConsultarHistoria extends javax.swing.JFrame {
    ...
    public ConsultarHistoria() {
     ...
     public void BuscarNome(){
        ...
        HistoriaDAO bd =  new HistoriaDAO(con);
        List<Historia> lista = new ArrayList();
        lista = bd.PesquisarNomeHistoria(nome.getText());
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while(tbm.getRowCount() > 0){
            tbm.removeRow(0);
        }
   ...
   dispose();
    ...
    private void BCod1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCod1ActionPerformed
      String codigo = cod.getText();
        ...
        List<Historia> lista = new ArrayList<>();
        lista = sql.PesquisarCodigoHistoria(codigo);
        DefaultTableModel tbm = (DefaultTableModel) Tabela.getModel();
        while (tbm.getRowCount() > 0) {
            tbm.removeRow(0);
        }
