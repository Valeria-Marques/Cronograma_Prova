...
public class AlterarIngles extends javax.swing.JFrame {

    public AlterarIngles() {
        initComponents();
        setSize(781,410);
    }
     private void InserirDados(int cod) {
        ...
        lista = sql.CapturarIngles(cod);
        for (Ingles i : lista) {
            conteudo.setText("" + i.getConteudo());
            data.setText("" + i.getData());
            hora.setText("" + i.getHora());
            Fcod.setText(""+ i.getId());
        }
