...
public class AlterarFisica extends javax.swing.JFrame {

    public AlterarFisica() {
        initComponents();
        setSize(781,410);
    }
    ...
    private void alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarActionPerformed
        ...
        if (conteudo.equals("") || data.equals("") || hora.equals("")) {
            ...
            Fisica ff = new Fisica();
            ff.setId(idF);
            ff.setConteudo(cont);
            ff.setData(dat);
            ff.setHora(h);
            sql.AlterarFisica(ff);
            Conexao.FecharConexao(con);
            conteudo.setText("");
            Fcod.setText("");
            cod.setText("");
