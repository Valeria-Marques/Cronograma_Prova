...
public class AlterarEspanhol extends javax.swing.JFrame {

    public AlterarEspanhol() {
        initComponents();
        setSize(781,410);
    }
     private void InserirDados(int cod) {
        ...
        lista = sql.CapturarEspanhol(cod);
        for (Espanhol e : lista) {
            conteudo.setText("" + e.getConteudo());
            data.setText("" + e.getData());
            hora.setText("" + e.getHora());
            Fcod.setText(""+ e.getId());
        }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (sql.TestarEspanhol(cod) == false) {
