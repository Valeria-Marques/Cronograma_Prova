...
public class AlterarSociologia extends javax.swing.JFrame {

    public AlterarSociologia() {
        initComponents();
        setSize(781,410);
    }
     private void InserirDados(int cod) {
        ...
        lista = sql.CapturarSociologia(cod);
        for (Sociologia s : lista) {
            conteudo.setText("" + s.getConteudo());
            data.setText("" + s.getData());
            hora.setText("" + s.getHora());
            Fcod.setText(""+ s.getId());
        }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (sql.TestarSociologia(cod) == false) {
