...
public class AlterarBiologia extends javax.swing.JFrame {

    public AlterarBiologia() {
        initComponents();
        setSize(781,410);
    }
     private void InserirDados(int cod) {
        ...
        lista = sql.CapturarBiologia(cod);
        for (Biologia b : lista) {
            conteudo.setText("" + b.getConteudo());
            data.setText("" + b.getData());
            hora.setText("" + b.getHora());
            Fcod.setText(""+ b.getId());
        }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (sql.TestarBiologia(cod) == false) {
