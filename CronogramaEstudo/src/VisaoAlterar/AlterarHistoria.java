...
public class AlterarHistoria extends javax.swing.JFrame {

    public AlterarHistoria() {
        initComponents();
        setSize(781,410);
    }
     private void InserirDados(int cod) {
        ...
        lista = sql.CapturarHistoria(cod);
        for (Historia h : lista) {
            conteudo.setText("" + h.getConteudo());
            data.setText("" + h.getData());
            hora.setText("" + h.getHora());
            Fcod.setText(""+ h.getId());
        }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (sql.TestarHistoria(cod) == false) {
