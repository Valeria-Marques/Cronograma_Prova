...
public class AlterarFilosofia extends javax.swing.JFrame {

    public AlterarFilosofia() {
        initComponents();
        setSize(781,410);
    }
     private void InserirDados(int cod) {
        Connection con = Conexao.AbrirConexao();
        FilosofiaDAO sql = new FilosofiaDAO(con);
        List<Filosofia> lista = new ArrayList<>();
        lista = sql.CapturarFilosofia(cod);
        for (Filosofia f : lista) {
            conteudo.setText("" + f.getConteudo());
            data.setText("" + f.getData());
            hora.setText("" + f.getHora());
            Fcod.setText(""+ f.getId());
        }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (sql.TestarFilosofia(cod) == false) {
    ...
    private void alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarActionPerformed
        ...
        if (conteudo.equals("") || data.equals("") || hora.equals("")) {
            ...
            Filosofia ff = new Filosofia();
            ff.setId(idF);
            ff.setConteudo(cont);
            ff.setData(dat);
            ff.setHora(h);
            sql.AlterarFilosofia(ff);
            Conexao.FecharConexao(con);
            conteudo.setText("");
            Fcod.setText("");
            cod.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Filosofia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
