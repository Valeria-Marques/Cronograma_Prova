...
public class AlterarGeografia extends javax.swing.JFrame {

    public AlterarGeografia() {
        initComponents();
        setSize(781,410);
    }
     private void InserirDados(int cod) {
        ...
        lista = sql.CapturarGeografia(cod);
        for (Geografia g : lista) {
            conteudo.setText("" + g.getConteudo());
            data.setText("" + g.getData());
            hora.setText("" + g.getHora());
            Fcod.setText(""+ g.getId());
        }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (sql.TestarGeografia(cod) == false) {
