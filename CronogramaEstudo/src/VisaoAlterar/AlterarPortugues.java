...
public class AlterarPortugues extends javax.swing.JFrame {

    public AlterarPortugues() {
        initComponents();
        setSize(781,410);
    }
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        if (sql.TestarPortugues(cod) == false) {
