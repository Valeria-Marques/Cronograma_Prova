...
public class CronogramaConsultar extends javax.swing.JFrame {

    
    public CronogramaConsultar() {
        initComponents();
        setSize(777,382);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Conteudos:");
  ...
  new Opcoes().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CronogramaConsultar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
