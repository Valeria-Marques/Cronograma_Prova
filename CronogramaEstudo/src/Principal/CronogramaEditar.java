...
import VisaoAlterar.AlterarFuncionario;
...
public class CronogramaEditar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Conteudos:");
        ...
        salvar1.setBounds(140, 270, 120, 40);
        ...
        salvar.setBounds(490, 270, 120, 40);
  ...
  new Opcoes().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CronogramaEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
