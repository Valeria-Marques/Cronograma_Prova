...
public class CronogramaCadastrar extends javax.swing.JFrame {

    
    public CronogramaCadastrar() {
        initComponents();
        setSize(777,382);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar Conteudos:");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(190, 20, 400, 50);
...
new Opcoes().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CronogramaCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
