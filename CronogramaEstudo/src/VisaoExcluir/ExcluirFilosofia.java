...
public class ExcluirFilosofia extends javax.swing.JFrame {

    public ExcluirFilosofia() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
    ...
    lista =  sql.ListarComboFilosofia();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Filosofia");
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoFilosofia(nome);
    
    for(Filosofia e: lista){
        int a = e.getId();
        Cod.setText("" + a);    
    }
    Conexao.FecharConexao(con);  
