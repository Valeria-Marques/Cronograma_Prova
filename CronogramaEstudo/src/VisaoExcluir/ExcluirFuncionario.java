...
public class ExcluirFuncionario extends javax.swing.JFrame {
    ...
    lista =  sql.ListarComboUsuario();
    for(Funcionario b : lista){
       ComboBio.addItem(b.getNome()); 
    }
   ...
   dispose();
    ...
    String no = ComboBio.getSelectedItem().toString();
    ...
    lista = sql.ConsultaCodigoUsuario(nome);
