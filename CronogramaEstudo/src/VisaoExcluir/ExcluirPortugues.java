...
public class ExcluirPortugues extends javax.swing.JFrame {

    public ExcluirPortugues() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
    ...
    lista =  sql.ListarComboPortugues();
    for(Portugues f : lista){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Portugues");
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoPortugues(nome);
    
    for(Portugues e: lista){
        int a = e.getId();
        Cod.setText("" + a);    
    }
    Conexao.FecharConexao(con);  
