...
public class ExcluirSociologia extends javax.swing.JFrame {

    public ExcluirSociologia() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
    ...
    SociologiaDAO sql = new SociologiaDAO(con);
    List<Sociologia> lista = new ArrayList<>();
    lista =  sql.ListarComboSociologia();
    for(Sociologia f : lista){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Sociologia");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(220, 30, 390, 50);
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoSociologia(nome);
    
    for(Sociologia e: lista){
        int a = e.getId();
        Cod.setText("" + a);    
    }
    Conexao.FecharConexao(con);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sociologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
