...
public class ExcluirQuimica extends javax.swing.JFrame {

    public ExcluirQuimica() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Quimica");
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoQuimica(nome);
