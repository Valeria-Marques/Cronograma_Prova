...
public class ExcluirBiologia extends javax.swing.JFrame {

    public ExcluirBiologia() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoBiologia(nome);
