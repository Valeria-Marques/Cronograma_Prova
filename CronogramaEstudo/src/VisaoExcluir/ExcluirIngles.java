...
public class ExcluirIngles extends javax.swing.JFrame {

    public ExcluirIngles() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Ingles");
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoIngles(nome);
