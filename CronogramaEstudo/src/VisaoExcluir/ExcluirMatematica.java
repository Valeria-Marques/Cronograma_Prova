...
public class ExcluirMatematica extends javax.swing.JFrame {

    public ExcluirMatematica() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
    ...
    lista =  sql.ListarComboMatematica();
    for(Matematica f : lista){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Matematica");
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoMatematica(nome);
    
    for(Matematica e: lista){
        int a = e.getId();
        Cod.setText("" + a);    
    }
    Conexao.FecharConexao(con);  
