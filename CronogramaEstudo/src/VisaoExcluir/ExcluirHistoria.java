...
public class ExcluirHistoria extends javax.swing.JFrame {

    public ExcluirHistoria() {
        initComponents();
        setSize(781,410);
         AtualizarCombo();
    }
    ...
    HistoriaDAO sql = new HistoriaDAO(con);
    List<Historia> lista = new ArrayList<>();
    lista =  sql.ListarComboHistoria();
    for(Historia f : lista){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Historia");
   ...
   dispose();
    ...
    lista = sql.ConsultaCodigoHistoria(nome);
    
    for(Historia e: lista){
        int a = e.getId();
        Cod.setText("" + a);    
    }
    Conexao.FecharConexao(con);  
